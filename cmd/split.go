...
var splitCmd = &cobra.Command{
	Use:   "split",
	Short: "Split a video based on a plan file",
...
func init() {
	...
	splitCmd.Flags().StringVarP(&videoPath, "video", "v", "", "path to the video file")
	splitCmd.Flags().StringVarP(&planPath, "plan", "p", "", "path to the plan CSV file")
}
